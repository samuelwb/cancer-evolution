...
#          the reference batch version of ComBat and save a session that can be used
...
gfp_kras_file       <- paste(signatures_dir,"36_GFP_KRAS_TPMlog2.txt",sep="/")
key_assign_file     <- "Key_ASSIGN_functions.R"
testFile            <- "Patient2_RNA_Combined.tpmlog"

#--------------------------------------#
#Output Files (modify these every time)#
#--------------------------------------#
working_dir         <- "RNA_Chronological"
output_rda          <- "output.rda"
